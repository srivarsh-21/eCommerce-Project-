...
<body class="overflow-x-hidden bg-white text-dark">
    ...
    <div class=" mt-5 pt-5">
        <div class="d-flex flex-wrap mt-4 justify-content-between align-items-center py-2 w-100 px-3 border border-2 bg-white" style="box-shadow: 0px 4px 4px 0px #00000040 ; ">
            <div class="left-section d-flex flex-wrap align-items-center gap-4">
                <select class="form-select form-select-sm w-auto pt-2 pb-2 border-2 border-black rounded-2 " id="categorySelect">
                ...
                <div class="tabs d-flex flex-wrap gap-4">
                    <a href="#" class="tab active" data-category="car">Car</a>
                    <a href="#" class="tab" data-category="bike">Bike</a>
                    <a href="#" class="tab" data-category="e-vehicle">E–Vehicle <i class="bi bi-caret-down-fill"></i></a>
                    <a href="#" class="tab" data-category="other">Other Vehicles</a>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="altroz-banner my-5 mx-lg-5">
                <img src="./assets/image/Hero.png" alt="Altroz Banner" class="img-fluid rounded">
            </div>

            <div class=" mx-lg-5 mt-5">
                <section class="mb-5">
                    <h2 class="mb-1">Compare Cars and Choose the Best</h2>
                    <p class=" mb-1">Find the perfect car by comparing features, prices, mileage, and more.</p>
                    <p class="small mb-4">Not sure which car suits your needs? Use our easy comparison tool to compare different cars side by side. Check their specifications, features, price ranges, and key details to make an informed decision before buying.</p>

                    <section class="container my-5">
                        <h2 class="text-center mb-4">Add Cars to Compare</h2>
                        <div class="row justify-content-center align-items-center g-3">
                            <div class="col-md-4">
                                <div class="car-card p-4 text-center" id="car1-card">
                                    <button class="add-car-btn" data-bs-toggle="modal" data-bs-target="#carSelectionModal" data-car-slot="1">
                            ...
                            <div class="col-md-4">
                                <div class="car-card p-4 text-center" id="car2-card">
                                    <button class="add-car-btn" data-bs-toggle="modal" data-bs-target="#carSelectionModal" data-car-slot="2">
                                        <i class="bi bi-plus-lg"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <button class="btn compare-btn" id="startComparisonBtn" >compare</button>
                        </div>
                    </section>

                    <section class="container my-5" id="comparisonResult" style="display: none;">
                        <h2 class="text-center mb-4">Detailed Comparison</h2>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="car-comparison-card">
                                    <img id="result-car1-image" src="" alt="Car 1" class="car-image">
                                    <div class="p-3">
                                        <h4 id="result-car1-name"></h4>
                                        <p class="text-muted" id="result-car1-brand"></p>
                                        <p class="fw-bold text-primary" id="result-car1-price"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="car-comparison-card">
                                    <img id="result-car2-image" src="" alt="Car 2" class="car-image">
                                    <div class="p-3">
                                        <h4 id="result-car2-name"></h4>
                                        <p class="text-muted" id="result-car2-brand"></p>
                                        <p class="fw-bold text-primary" id="result-car2-price"></p>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <h3 class="mt-5 mb-3 text-center">Feature Breakdown</h3>
                        <div class="comparison-table border rounded p-3">
                            <!-- Feature rows will be dynamically populated by JS -->
                            <div class="row">
                                <div class="col-4 feature-title">Engine</div>
                                <div class="col-4 feature-value" id="feature-engine-car1"></div>
                                <div class="col-4 feature-value" id="feature-engine-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Mileage</div>
                                <div class="col-4 feature-value" id="feature-mileage-car1"></div>
                                <div class="col-4 feature-value" id="feature-mileage-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Transmission</div>
                                <div class="col-4 feature-value" id="feature-transmission-car1"></div>
                                <div class="col-4 feature-value" id="feature-transmission-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Fuel Type</div>
                                <div class="col-4 feature-value" id="feature-fuel-car1"></div>
                                <div class="col-4 feature-value" id="feature-fuel-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Seating Capacity</div>
                                <div class="col-4 feature-value" id="feature-seating-car1"></div>
                                <div class="col-4 feature-value" id="feature-seating-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Color Options</div>
                                <div class="col-4 feature-value" id="feature-color-car1"></div>
                                <div class="col-4 feature-value" id="feature-color-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Airbags</div>
                                <div class="col-4 feature-value" id="feature-airbags-car1"></div>
                                <div class="col-4 feature-value" id="feature-airbags-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Sunroof</div>
                                <div class="col-4 feature-value" id="feature-sunroof-car1"></div>
                                <div class="col-4 feature-value" id="feature-sunroof-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Infotainment</div>
                                <div class="col-4 feature-value" id="feature-infotainment-car1"></div>
                                <div class="col-4 feature-value" id="feature-infotainment-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Parking Sensors</div>
                                <div class="col-4 feature-value" id="feature-parking-sensors-car1"></div>
                                <div class="col-4 feature-value" id="feature-parking-sensors-car2"></div>
                            </div>
                            <div class="row">
                                <div class="col-4 feature-title">Boot Space</div>
                                <div class="col-4 feature-value" id="feature-boot-space-car1"></div>
                                <div class="col-4 feature-value" id="feature-boot-space-car2"></div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-xl">
                            <div class="modal-content">
                                <div class="modal-header bg-primary text-white">
                                    <h5 class="modal-title" id="carSelectionModalLabel">
                                        <i class="fas fa-car me-2"></i>
                                        <span id="modalTitle">Select your car brand</span>
                                    </h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-4">
                                        <div class="position-relative">
                                            ...
                                            <input type="text" class="form-control search-box ps-5" id="searchInput" placeholder="Search your brand">
                                        </div>
                                    </div>
                                    ...
                                    <div id="modelSelection" style="display: none;">
                                        <div class="mb-3">
                                            <button class="btn btn-outline-secondary" onclick="goBackToBrands()">
                                                <i class="fas fa-arrow-left me-2"></i>Back to Brands
                                            </button>
                                        </div>
                                        <h6 class="mb-3">Popular models</h6>
                                        <div class="row" id="popularModels"></div>
                                        <h6 class="mb-3 mt-4">All models</h6>
                                        <div class="row" id="allModels"></div>
                                    </div>

                                    <!-- Variant Selection -->
                                    <div id="variantSelection" style="display: none;">
                                        <div class="mb-3">
                                            <button class="btn btn-outline-secondary" onclick="goBackToModels()">
                                                <i class="fas fa-arrow-left me-2"></i>Back to Models
                                            </button>
                                        </div>
                                        <h6 class="mb-3">Variant</h6>
                                        <div class="row" id="variantGrid"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="py-5 rounded mx-lg-5 mb-5 bg-white">
                        <div class="container position-relative">
                            <h2 class="mb-4 fw-bold">Popular Car Comparisons</h2>
                            <div class="compare-slider">
                                <div class="compare-container rounded-none cars-container">
                                    <!-- Cars will be loaded here by jQuery -->
                                </div>
                            </div>
                            <button class="btn btn-light position-absolute top-50 start-0 translate-middle-y rounded-circle p-2 shadow-sm scroll-button"
                                onclick="scrollCarousel('.cars-container', -1)">
                                <i class="bi bi-chevron-left"></i>
                            </button>
                            <button class="btn btn-light position-absolute top-50 end-0 translate-middle-y rounded-circle p-2 shadow-sm scroll-button"
                                onclick="scrollCarousel('.cars-container', 1)">
                    ...
                    <!-- Compare -->
                    <div class="cards-compare-container g-2 container my-3">
                        <h3 class="mb-4 fw-bold">Compare Cars by BodyType</h3>
                        <div class="row g-4 align-items-center">
                            <!-- Compare Carousel -->
                            <div class="col-lg-8 border border-1 border-dark rounded-3 p-3">
                                <div class="position-relative">
                                    <div class="compare-slider">
                                        <div class="compare-container rounded-none cars-container">
                                            <!-- Cars will be loaded here by jQuery -->
                            ...
                            <!-- Book a Test Drive Image -->
                            <div class="col-lg-4 text-center">
                                <img src="./assets/image/book-a-test-drive.png" style="width: 100%;" alt="Book a Test Drive" class="img-fluid rounded">
                            </div>
                        </div>
                    </div>
                    ...
                    <section class="faq-card ">
                        <div class="faq p-4 rounded-3 shadow-sm bg-white border-black">
                            <h2 class="section-title text-center mb-4 fw-bold">Frequently Asked Questions</h2>
                            <div class="accordion  container my-3 " id="faqAccordion">
                            </div>
                        </div>
                    </section>
            </div>
            ...
            <script>
                ...
                const allCarsData = [{
                        id: 1,
                        name: 'Grand i10 Nios Sportz',
                        brand: 'Hyundai',
                        price: '₹ 6,50,000',
                        showroomPrice: '₹ 7,00,000 (Ex-Showroom)',
                        image: './assets/image/grand_i10_nios.png',
                        category: 'hatchback',
                        features: {
                    ...
                    },
                    {
                        ...
                        brand: 'Honda',
                        price: '₹ 10,00,000',
                        showroomPrice: '₹ 11,50,000 (Ex-Showroom)',
                    ...
                    },
                    {
                        ...
                        brand: 'Hyundai',
                        price: '₹ 12,00,000',
                        showroomPrice: '₹ 14,00,000 (Ex-Showroom)',
                    ...
                    {
                        id: 4,
                        name: 'Nexon EV Prime XZ+',
                        brand: 'Tata',
                        price: '₹ 14,50,000',
                        showroomPrice: '₹ 15,30,000 (Ex-Showroom)',
                    ...
                    },
                    {
                        ...
                        brand: 'Maruti Suzuki',
                        price: '₹ 7,20,000',
                        showroomPrice: '₹ 7,80,000 (Ex-Showroom)',
                        image: './assets/image/maruti_swift.png',
                        category: 'hatchback',
                        features: {
                    ...
                    },
                    {
                        ...
                        brand: 'Hyundai',
                        price: '₹ 13,50,000',
                        showroomPrice: '₹ 15,00,000 (Ex-Showroom)',
                        image: './assets/image/hyundai_verna.png',
                        category: 'sedan',
                        features: {
                    ...
                    },
                    {
                        ...
                        brand: 'Mahindra',
                        price: '₹ 14,00,000',
                        showroomPrice: '₹ 16,50,000 (Ex-Showroom)',
                        image: './assets/image/mahindra_thar.png',
                        category: 'suv',
                        features: {
                    ...
                    },
                    {
                        ...
                        brand: 'Tata',
                        price: '₹ 9,00,000',
                        showroomPrice: '₹ 9,50,000 (Ex-Showroom)',
                        image: './assets/image/tata_tiago_ev.png',
                        category: 'electric',
                        features: {
                            engine: 'Electric Motor',
                ...
                const carSelectionData = {
                    brands: [{
                            name: 'Suzuki',
                            logo: './assets/icon/suzuki.png',
                            models: ['Swift', 'Baleno', 'Wagon R 1.0', 'Alto', 'Esteem', 'Gypsy', 'Omni', 'Versa', 'Wagon R', 'Wagon R MAV', 'Zen']
                        },
                        {
                            name: 'Toyota',
                            logo: './assets/icon/toyota.png',
                            models: ['Camry', 'Corolla', 'Prius', 'Yaris']
                        },
                        {
                            name: 'Tata',
                            logo: './assets/icon/tata.png',
                            models: ['Nexon', 'Harrier', 'Safari', 'Altroz']
                        },
                        {
                            name: 'Hyundai',
                            logo: './assets/icon/hyundai.png',
                            models: ['i20', 'Creta', 'Verna', 'Grand i10']
                        },
                        {
                            name: 'Mahindra',
                            logo: './assets/icon/mahindra.png',
                            models: ['XUV700', 'Thar', 'Scorpio', 'Bolero']
                        },
                        {
                            name: 'Honda',
                            logo: './assets/icon/honda.png',
                            models: ['City', 'Amaze', 'Jazz', 'WR-V']
                        },
                        {
                            name: 'Ford',
                            logo: './assets/icon/ford.png',
                            models: ['EcoSport', 'Endeavour', 'Figo', 'Aspire']
                        },
                        {
                            name: 'Fiat',
                            logo: './assets/icon/fiat.png',
                            models: ['Punto', 'Linea', 'Avventura']
                        },
                        {
                            name: 'Nissan',
                            logo: './assets/icon/nissan.png',
                            models: ['Magnite', 'Kicks', 'Sunny', 'Terrano']
                        },
                        {
                            name: 'Kia',
                            logo: './assets/icon/kia.png',
                            models: ['Seltos', 'Sonet', 'Carnival']
                        },
                        {
                            name: 'Volkswagen',
                            logo: './assets/icon/volkswagen.png',
                            models: ['Polo', 'Vento', 'Tiguan', 'T-Cross']
                        },
                        {
                            name: 'MG',
                            logo: './assets/icon/mg.png',
                            models: ['Hector', 'ZS EV', 'Gloster']
                        },
                        {
                            name: 'Renault',
                            logo: './assets/icon/renault.png',
                            models: ['Kwid', 'Duster', 'Kiger', 'Triber']
                        },
                        {
                            name: 'Isuzu',
                            logo: './assets/icon/isuzu.png',
                            models: ['D-Max', 'MU-X']
                        },
                        {
                            name: 'Jaguar',
                            logo: './assets/icon/jaguar.png',
                            models: ['XE', 'XF', 'F-Pace', 'E-Pace']
                        },
                        {
                            name: 'BMW',
                            logo: './assets/icon/bmw.png',
                            models: ['3 Series', '5 Series', 'X1', 'X3']
                        },
                        {
                            name: 'Audi',
                            logo: './assets/icon/audi.png',
                            models: ['A4', 'A6', 'Q3', 'Q5']
                        },
                        {
                            name: 'Rolls Royce',
                            logo: './assets/icon/rollsroyce.png',
                            models: ['Phantom', 'Ghost', 'Wraith']
                        },
                        {
                            name: 'Acura',
                            logo: './assets/icon/acura.png',
                            models: ['MDX', 'RDX', 'TLX']
                        }
                    ],
    ...
    `;
        ...
        `);
                        ...
                        // console.log(`Appended brand: ${brand.name}`); // Commented for less verbose logging
                    });
                    console.log(`Populated ${carSelectionData.brands.length} brands.`);
                }
    ...
    faqs.forEach(function(faq, index) {
        ...
        <div class="accordion-item border-0 border-bottom">
            <h2 class="accordion-header" id="heading-${index}">
                <button class="accordion-button collapsed bg-white fw-normal" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-${index}" aria-expanded="false" aria-controls="collapse-${index}">
                    ...
                    const cars = [ // This data is for the popular comparison section
                        {
                            car1: {
                                ...
                                image: 'assets/image/comaprepage-car1.png'
                            },
                            car2: {
                                brand: 'Hyundai',
                                ...
                                fuel: 'Petrol',
                                showroom: 'Ex Showroom Price',
                                image: 'assets/image/comparepage-car2.png'
                            }
                        },
                        {
                            car1: {
